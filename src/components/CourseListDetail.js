...
export default
  function CourseListDetail({ courseData, onEditClick, onDeleteClick }) {
        ...
        <div className="flex-grow p-4">
          ...
          <div className='flex flex-row items-center justify-between'>
            ...
            <div className='flex space-x-4 pr-6'>
              <div className="flex flex-row space-x-2 text-[#6E6E6E] items-center cursor-pointer hover:underline" onClick={onEditClick}>
                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4.93291 12.2213L12.7333 4.42087L11.6458 3.33334L3.84537 11.1338V12.2213H4.93291ZM5.57051 13.7595H2.30713V10.4962L11.102 1.70126C11.2463 1.55707 11.4418 1.47607 11.6458 1.47607C11.8497 1.47607 12.0453 1.55707 12.1896 1.70126L14.3654 3.8771C14.5096 4.02134 14.5906 4.21693 14.5906 4.42087C14.5906 4.62482 14.5096 4.82041 14.3654 4.96464L5.57051 13.7595ZM2.30713 15.2978H16.1513V16.836H2.30713V15.2978Z" fill="#6E6E6E" />
                </svg>
                <p>Edit</p>
              </div>
              <div className="flex flex-row space-x-2 text-[#FB285E] items-center cursor-pointer hover:underline" onClick={onDeleteClick}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 19C4.45 19 3.97917 18.8042 3.5875 18.4125C3.19583 18.0208 3 17.55 3 17V4H2V2H7V1H13V2H18V4H17V17C17 17.55 16.8042 18.0208 16.4125 18.4125C16.0208 18.8042 15.55 19 15 19H5ZM15 4H5V17H15V4ZM7 15H9V6H7V15ZM11 15H13V6H11V15Z" fill="#FB285E" />
                </svg>
                <p>Delete</p>
              </div>
            </div>
          ...
          <div className="flex items-center text-sm font-medium text-gray-400 space-x-2">
            ...
            <span className="text-gray-400">|</span> <div className="flex items-center gap-2 w-24">
