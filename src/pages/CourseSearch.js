    ...
    return (
        <>
            <div className="w-screen p-16">
                <div className="w-screen grid grid-cols-[4rem_1fr_1fr] items-center justify-between relative">
                    ...
                    <div className="bg-gray-300 w-84 h-12 col-span-1 rounded-xl flex items-center justify-center absolute right-36">
                ...
                <div className="w-screen grid grid-cols-3 items-center justify-center p-12">
                    <div className="h-[21rem] w-80 overflow-hidden shadow-md">
                        <img className="" src={Course1}></img>
                        ...
                        <div className="w-full grid grid-flow-col grid-cols-[22%-22%-6%-22%-6%-22%] items-center justify-center mt-2 p-1 pr-28">
                            <FaHeart className="h-6 w-6 text-pink-400 mr-1" />
                            <p className="text-sm text-gray-400 font-medium">257</p>
