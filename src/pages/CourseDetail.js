                        ...
                        <main className="flex-1 bg-gray-50 p-6 md:p-8 rounded-2xl lg:rounded-tl-2xl lg:rounded-tr-none lg:rounded-br-none lg:rounded-bl-none">
                            <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10">
                                ...
                                <div className="flex-1">
                                    <h2 className="font-medium text-2xl md:text-3xl text-gray-900">{title}</h2>

                                    <div className="flex flex-wrap items-center text-gray-500 gap-3 mt-3 text-sm">
                                        <span>{author}</span>
                                        <span className="hidden md:inline">•</span>
                                        <div className="flex items-center gap-2">
                                            <svg className="w-4 h-4 text-blue-400" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <svg className="w-4 h-4 text-blue-400" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
                                <img src={image} alt={title} className="w-full h-64 md:h-80 lg:h-96 object-cover rounded-lg" />

                                <div>
                                    <p className="text-2xl md:text-3xl font-medium mb-4">Course Contents</p>
                                            ...
                                            {courseDetail?.curriculum && courseDetail.curriculum.length > 0 ? (
                                                courseDetail.curriculum.map((curriculum, idx) => (
                                                    <li key={idx} className="text-lg flex items-start">
                                                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-3 mt-1 flex-shrink-0">
                                    ...
                                    <div className="flex justify-center lg:justify-start py-8">
                                        <button className="w-full lg:w-3/4 text-white text-lg px-6 py-3 rounded-lg mt-6 bg-blue-600 hover:bg-blue-700 transition duration-300 font-semibold shadow-md" onClick={() => handleEnrollClick()}>
                                            Enroll In Course &#8594;
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div className="mt-6">
                                <p className="text-2xl font-medium mt-4 mb-4">About</p>
                                <div className="bg-white p-6 rounded-lg">
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <p className="text-sm md:text-base text-gray-700 px-1">
                                                {courseDetail?.courseOverview || "No overview available."}
                                            </p>
                                        </div>
                                            ...
                                            <ul className="list-disc list-inside space-y-2 pl-6">
                                                {courseDetail?.whatYouWillLearn && courseDetail.whatYouWillLearn.length > 0 ? (
                                                    courseDetail.whatYouWillLearn.map((learn, idx) => (
                                                        <li key={idx} className="text-md text-gray-700">{learn}</li>
                                                    ))
                                                ) : (
                                                    <p className="text-sm text-gray-500">No data</p>
                                                )}
