    ...
    return (
        ...
        <div className="w-full bg-gray-50 p-6 md:p-10 rounded-2xl md:rounded-3xl mr-0 md:mr-10 mt-6 md:mt-12">
            <div className="w-full flex items-center gap-3 ml-2 md:ml-20 mt-4 md:mt-10">
                ...
                <h2 className="font-semibold text-2xl md:text-3xl">Dashboard-Student</h2>
            </div>

                    {/*  Profile & Events */}
                    <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-center p-6 md:p-20">


                        {/* LEFT->PROFILE */}
                        <div className="flex flex-row justify-between md:col-span-2 mb-0 md:mb-0">
                            <p className="font-medium text-xl md:text-2xl">My profile</p>
                            <a href="#" className="text-[#2D9CDB] pt-2">Add/Edit</a>
                        </div>

                        <div className="flex flex-row justify-between mb-0 md:mb-0">
                            <p className="font-medium text-xl md:text-2xl">Events</p>
                            <a href="#" className="text-[#2D9CDB] pt-2">Show all</a>
                        </div>

                        {/* Profile card */}
                        <div className="md:h-[21rem] h-auto w-full shadow-md md:col-span-2 bg-white flex flex-col md:flex-row items-start md:items-center p-4 md:p-1 gap-4 rounded-lg">
                            <div className="flex flex-col items-center w-full md:w-[180px] min-w-[160px]">
                                <a href="#">
                                    <img src={UserEditIcon} className="w-28 h-28 md:w-19 md:h-19 object-cover" />
                                </a>
                                <p className="font-normal text-lg mt-4 md:mt-5">Kenta Onzo</p>
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-[130px_1fr] gap-y-2 gap-x-4 flex-1">
                        ...
                        {/* Calendar */}
                        <div className="md:h-[21rem] h-auto w-full shadow-md bg-white rounded-lg">
                            <div className="p-4">
                        ...
                        {/*My Course & My Work*/}
                        <div className="col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-5">

                            {/* MY COURSE */}
                            <div className="col-span-2">
                                <div className="flex flex-row justify-between mb-4">
                                    <p className="font-medium text-xl md:text-2xl">My Course</p>
                                    <a href="#" className="text-[#2D9CDB] pt-2">Explore All Courses</a>
                                </div>

                                <div className="flex flex-col gap-4">

                                    {/* COURSE 1 */}
                                    <div className="bg-white shadow-md flex flex-col md:flex-row overflow-hidden rounded-lg">
                                        <img src={Course1} className="w-full md:w-[40%] h-[140px] object-cover block" />
                                    ...
                                    {/* COURSE 2 */}
                                    <div className="bg-white shadow-md flex flex-col md:flex-row overflow-hidden rounded-lg">
                                        <img src={Course2} className="w-full md:w-[32%] h-[140px] object-cover block" />
                                        <div className="flex flex-col w-full p-4">
                                    ...
                                    {/* COURSE 3 */}
                                    <div className="bg-[#ECECEC] shadow-md flex flex-col md:flex-row overflow-hidden rounded-lg">
                                        <img src={Course3} className="w-full md:w-[40%] h-[140px] object-cover block" />
                                        <div className="flex flex-col w-full p-4">
                            ...
                            <div className="col-span-1">
                                <div className="flex flex-row justify-between mb-4">
                                    <p className="font-medium text-xl md:text-2xl">My Work</p>
                                    <a href="#" className="text-[#2D9CDB] pt-2">Show All</a>
                                </div>
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    {/*1 */}
                                    <a href="#">
                                        <div className="bg-white shadow p-4 flex justify-between items-center rounded-lg">
                                            <div>
                                    ...
                                    {/*2 */}
                                    <a href="#">
                                        <div className="bg-[#D6D6D6]/50 p-4 shadow flex justify-between items-center rounded-lg">
                                            <div>
                                                <span className="bg-[#2D9CDB] text-white px-3 py-1 rounded-full text-sm">
                                                    Java Script Course
                                                </span>
