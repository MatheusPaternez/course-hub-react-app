...
|---|---|---|---|---|
| 1 | Homepage : HTML design and make it responsible |  |  | Done |
| 1 | Homepage : make react Component |  |  | Done |
| 1 | Homepage : making the page adapt to JSX(react) |  |  | Done |
| 1 | Homepage : Footer: HTML and Tailwind |  |  | Done |
| 1 | Homepage : animation design |  |  | Done |
| 1 | Design:HomePage, Login,  Dash-board |  |  |  Done |
| 2 | Login popup page: HTML and Tailwind |  |  | Done |
| 2 | Design: Dashboard ,find team mates page design, UI,UX|  |  | Done |
| 4 | CourseSearchPage : making the page adapt to JSX(react) |  |  | Done |
